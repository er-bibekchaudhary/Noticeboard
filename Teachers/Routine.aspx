...
<tr>
<td colspan=7>
    <asp:DropDownList ID="DdlFaculty" runat="server" CssClass="form-control pull-left" Width="30%">
    ...
    <asp:DropDownList ID="DdlSemister" runat="server" CssClass="form-control pull-left" Width="10%">
    ...
    <asp:DropDownList ID="DdlShift" runat="server" CssClass="form-control pull-left" Width="10%">
